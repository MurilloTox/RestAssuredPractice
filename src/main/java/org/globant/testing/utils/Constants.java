...
public final class Constants {
    ...
    public static final  String DEFAULT_RESOURCE_FILE_PATH = "src/main/resources/data/defaultResources.json";
    ...
    public static final  String URL_WITH_OTHER_PARAM     = "/api/v1/%s?%s=%s";
